...
# 7. 배경 크기 (background-size)

배경의 크기도 조절할 수 있을까?<br>
...
<style>
    div{
        ...
        background-position:left top, right bottom;
        background-repeat:no-repeat, no-repeat;
        background-size:50% auto, auto 20%;
        overflow:auto;
    }
</style>
<div>
...
<div style="width:1000px;height:200px;background-image:url('https://www.google.com/images/branding/googlelogo/2x/googlelogo_color_92x30dp.png'), url('https://s.yimg.com/rz/p/yahoo_frontpage_en-US_s_f_p_205x58_frontpage_2x.png');background-position:left top, right bottom;background-repeat:no-repeat, no-repeat;overflow:auto;background-size:50% auto, auto 20%;">
    글자입니다. 너무 긴 글자에요... 진짜로 너무 길다고요...<br>
    글자입니다. 너무 긴 글자에요... 진짜로 너무 길다고요...<br>
    글자입니다. 너무 긴 글자에요... 진짜로 너무 길다고요...<br>
    글자입니다. 너무 긴 글자에요... 진짜로 너무 길다고요...<br>
...
위의 예시를 보면 각각 50% auto와 auto 20%의 값을 주었다.<br>

<br>

이 경우 google은 x축 크기가 50%에 y축 크기는 원래 이미지에 맞게 auto(자동)으로 조정되었고,<br>

<br>

yahoo! 는 x축 크기는 y축에 맞게 auto, y축 크기는 div 크기의 20%로 설정되었다.<br>

<br>

```css
background-size: auto; /*x축 y축값을 띄어쓰기로 구분지으며 % 뿐만 아니라 px, pt등 다양한 수치를 쓸 수 있다.
auto를 쓸 경우 다른 정해진 값에 의해 비율에 따라 크기가 맞춰진다.*/
```
